...
module.exports = function(callback) {
  ...
  var spenderAddress = process.env.SPENDER;
  if(typeof(spenderAddress) == 'undefined'){
    return;
  }
  ...
  contract.methods.approve(spenderAddress, web3.utils.toWei(amount, 'ether')).send({value: web3.utils.toWei('0', 'ether'), from: fromAddress})
